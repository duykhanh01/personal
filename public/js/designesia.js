...
(function ($) {
    ...
    function filter_gallery() {
        ...
        jQuery("#filters a.link").on("click", function () {
        ...
        jQuery(".center-xy").each(function () {
            jQuery(this)
                ...
                .on("load", function () {
                    ...
                    tp.find(".center-xy").css(
                        "left",
                        parseInt(pic_w, 10) / 2 - w / 2
                    );
                    tp.find(".center-xy").css(
                        "top",
                        parseInt(pic_h, 10) / 2 - h / 2
                    );
    ...
    function sequence() {
        ...
        for (var i = 0; i <= count; i++) {
            var sqx = jQuery(
                ".sequence > .gallery-item:eq(" + i + ") .picframe"
            );
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(".full-height .de-video-container").css(
            "min-height",
            $doc_height
        );
